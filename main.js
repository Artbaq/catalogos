...
var gorrasCat = [
    {url:"oModal('cur_',5)", imges:"cur_2.png", txt:'Gorras Curvadas'},
    {url:"oModal('pla_',6)", imges:"pla_5.png", txt:'Gorras Planas'},
	{url:"oModal('cap_',15)", imges:"cap_all.png", txt:'Ver todas +'},
];
...
var promoList = [
	{url:"oModal('tec_',20); showDivs(slideIndex = 1)" , image: "tec_0.png" , title: "Smart TV BOX plus" , senten: "Aprovecha que solo quedan pocos."},
	{url:"oModal('tec_',20); showDivs(slideIndex = 2)" , image: "tec_1.png" , title: "Receptor Bluetooth", senten: "Transmite sonido por Bluetooth."},
	{url:"oModal('tec_',20); showDivs(slideIndex = 3)" , image: "tec_2.png" , title: "Speaker Bluetooth" , senten: "Lleva tu musica a donde quieras."},
	{url:"oModal('cap_',13); showDivs(slideIndex = 6)" , image: "cap_5.png" , title: "Gorras Planas"	   , senten: "Tu mejor estilo para cada ocacion."},
	{url:"oModal('tec_',20); showDivs(slideIndex = 5)" , image: "tec_4.png" , title: "Game pad" 		   , senten: "Llevas tus juegos a otro nivel."}
];
promoList = promoList.concat(
    {url: "oModal('tec_',20); showDivs(slideIndex = 6)", image: "tec_5.png", title: "Cable HDMI", senten: "Para contenidos de alta calidad"}
    );
...
innerMenu(footer, menuList, 'Menú');
