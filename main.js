...
var technoCat = [   {url:"oModal('ear_',4)", imges:"ear_4.png", txt:'Audifonos & Bluetooth'},
                    ...
                    {url:"oModal('spe_',2)", imges:"spe_0.png", txt:'Speakers'},
                    {url:"oModal('tec_',20)",imges:"tec_1.png", txt:'Miscelaneos & más'},   ];

var promoList = [
	{url:"oModal('tec_',21); showDivs(slideIndex = 1)" , image: "tec_0.png" , title: "Smart TV BOX plus" , senten: "Aprovecha que solo quedan pocos."},
	{url:"oModal('tec_',21); showDivs(slideIndex = 2)" , image: "tec_1.png" , title: "Receptor Bluetooth", senten: "Transmite sonido por Bluetooth."},
	{url:"oModal('tec_',21); showDivs(slideIndex = 3)" , image: "tec_2.png" , title: "Speaker Bluetooth" , senten: "Lleva tu musica a donde quieras."},
	{url:"oModal('cap_',11); showDivs(slideIndex = 6)" , image: "cap_5.png" , title: "Gorras Planas"	   , senten: "Tu mejor estilo para cada ocacion."},
	{url:"oModal('tec_',21); showDivs(slideIndex = 5)" , image: "tec_4.png" , title: "Game pad" 		   , senten: "Llevas tus juegos a otro nivel."}
];
promoList.unshift(
    {   url: "oModal('tec_',20); showDivs(slideIndex = 6)", image: "tec_5.png", 
        title: "Cable HDMI", senten: "Para contenidos de alta calidad"} );

var iconsAndUrls = [
    {   name: "Nosotros", icon: "fa fa-user",                 url: "#" },
    {   name: "Catalogos",icon: "fa fa-list",                 url: "#catalogos" },
    {   name: "Facebook", icon: "fab fa-facebook-square",     url: "fb://facewebmodal/f?href=https://www.facebook.com/articulosbquilla" },
    {   name: "Instagram",icon: "fab fa-instagram",           url: "https://www.instagram.com/articulos_bquilla" },
    {   name: "Whatsapp", icon: "fab fa-whatsapp",            url: "https://api.whatsapp.com/send?phone=+573008546921"},
    {   name: "Linkedin", icon: "fab fa-linkedin",            url: "#" },
    {   name: "Google",   icon: "fab fa-google-plus-square",  url: "#"  }
];


let x = iconsAndUrls.slice(0,2);    
    let menuIcons = x.concat(iconsAndUrls.slice(4,5));
        let socialIcons = iconsAndUrls.slice(2,5);
